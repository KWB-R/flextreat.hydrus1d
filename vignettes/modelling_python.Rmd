...
if(is_windows) {
### Download Hydrus1D v4.08 executable 
### see: https://github.com/phydrus/source_code/issues/1#issuecomment-1034675697
source_path <- "https://www.pc-progress.com//Downloads/Pgm_Hydrus1D/H1D_4_08.exe"
exe_path <- file.path(getwd(), basename(source_path))
...
#                          )
# 
# binpath <- "C:/rtools40/mingw64/bin"
# 
# if(dir.exists(binpath)) {
# cmd <- paste0("set PATH=%PATH%;", kwb.utils::windowsPath(binpath), "\n", 
#               "cd ", kwb.utils::windowsPath(file.path(tdir, "source\n")),
#               "make.bat")
# writeLines(cmd, "batch.")
# }
# 
# system2(command = cmd)
...
ml.add_time_info(tinit=0, tmax=10)
